...
export default function OnboardingStep3() {
  ...
  const [selectedLength, setSelectedLength] = useState(28)
  const numbers = Array.from({ length: 21 }, (_, i) => i + 20) // 20 to 40 days
  ...
  const handleNext = () => {
    router.push({
      pathname: '/onboarding/step4-symptoms',
      params: {
        lastPeriodDate: params.lastPeriodDate as string,
        periodLength: params.periodLength as string,
        cycleLength: selectedLength.toString(),
      },
    })
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Enter your average cycle length</Text>
